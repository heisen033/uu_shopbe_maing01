...
const Errors = require("../api/errors/shopbe-main-error.js");
...
const logger = LoggerFactory.get("ShopbeMainAbl");
...
module.exports = new ShopbeMainAbl();
